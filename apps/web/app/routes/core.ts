  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // Trainings
        layout("./(all)/[workspaceSlug]/(projects)/trainings/layout.tsx", [
          route(":workspaceSlug/trainings", "./(all)/[workspaceSlug]/(projects)/trainings/page.tsx"),
        ]),
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/(workspace)/layout.tsx", [
          ...
          // Workspace-wide (global) automations
          route(
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            route(
              ":workspaceSlug/settings/projects/:projectId/service-desk",
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/service-desk/page.tsx"
            ),
            // Project Automations
